...
public isolated client class RentalServicePropertyMessageCaller {
    private final grpc:Caller caller;
    ...
    isolated remote function sendPropertyMessage(PropertyMessage response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextPropertyMessage(ContextPropertyMessage response) returns grpc:Error? {
        return self.caller->send(response);
    }
